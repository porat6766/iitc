...
const InfoPokimon = ({ pokoInfo, isOpen, setPokoInfo }) => {
  ...
  const componentsMap = {
    About: <About poke={pokoInfo.data} />,
    "Base stat": <BaseStat poke={pokoInfo.data} />,
    Evolution: <Evolution poke={pokoInfo.data} />,
    Moves: <Moves poke={pokoInfo.data} />,
  };
    ...
    <div className="info-container">
      <Dialog open={isOpen}>
        ...
        <DialogTitle className={styles.name}>
          <h1>{pokoInfo.data.name}</h1>
        </DialogTitle>
        <img
          className={styles.photo}
          src={pokoInfo.data.sprites.other["official-artwork"].front_shiny}
        />
        <div
          style={{
            width: "100%",
