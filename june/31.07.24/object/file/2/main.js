...
// 1. Create an object called `book` with properties: name (string), color (string), and sweetness (number from 1-10).
...
console.log(coomputer.brand, coomputer.cpu);

coomputer.RAMinGB = coomputer.RAMinGB * 2;
console.log(coomputer.RAMinGB);
